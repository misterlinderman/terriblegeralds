...
const CATERING_ITEMS = [
  ...
  'Corporate events & office drops',
  'Festivals & markets',
  'Private parties & backyard chaos',
];
      ...
      >
        ...
        >
          <PlaceholderBox
            ...
            style={{ gridRow: 'span 2', aspectRatio: 'auto' }}
          />
        ...
        <div>
          ...
          <Button variant="red" href="/catering">
            Request a Quote →
          </Button>
        </div>
      </div>
