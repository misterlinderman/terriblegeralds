  ...
  return (
    <footer className="site-footer">
      ...
      <ul className="social-list">
        <li>
          <a
            href="https://www.facebook.com/terriblegeralds/"
            target="_blank"
            rel="noreferrer"
            title="Terrible Gerald's on Facebook"
          >
        ...
        <li>
          <a href="https://www.tiktok.com/@terriblegeralds" target="_blank" rel="noreferrer">
            <img
              src="/images/the-tok.png"
              alt="Terrible Gerald's on TikTok"
              style={{ maxWidth: 50, translate: '0 -10px' }}
            />
          </a>
        </li>
        <li>
          <a
            href="https://www.instagram.com/terriblegeralds/"
            target="_blank"
            rel="noreferrer"
            title="Terrible Gerald's on Instagram"
          >
