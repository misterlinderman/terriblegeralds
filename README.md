...
npm run seed      # optional: load menu, FAQs, site copy
...
- **Events** — pop-up schedule (replaces Storyblok)
- **Menu** — pizza names, descriptions, images
- **FAQs** — homepage Q&A blocks
- **Site content** — hero tagline, about copy, contact form text
- **Inquiries** — private event form submissions

## Documentation

| Doc | Purpose |
|-----|---------|
| [SETUP.md](./SETUP.md) | Local env, Auth0, MongoDB |
